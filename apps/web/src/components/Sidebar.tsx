  ...
  return (
    <>
      ...
      <SidebarFooter className="gap-0 p-3">
        <button
          type="button"
          className="mb-2 flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-xs text-muted-foreground transition-colors duration-150 hover:bg-secondary hover:text-foreground"
